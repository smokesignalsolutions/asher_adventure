...
final Map<CharacterClass, ClassDefinition> classDefinitions = {
  ...
  CharacterClass.wizard: ClassDefinition(
    ...
    usesMagicForDamage: true,
    abilities: [
      Ability(name: 'Burning Hands', description: 'Flames scorch 2-4 enemies.', damage: 12, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true, minTargets: 2, maxTargets: 4),
      Ability(name: 'Fireball', description: 'A ball of fire hits 3-6 enemies.', damage: 14, refreshChance: 50, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 2, minTargets: 3, maxTargets: 6),
      Ability(name: 'Ice Storm', description: 'A freezing storm hits all enemies.', damage: 16, refreshChance: 45, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 5),
  ...
  CharacterClass.summoner: ClassDefinition(
    ...
    abilities: [
      ...
      Ability(name: 'Summon Wolf', description: 'A wolf spirit attacks a random enemy each turn.', damage: 0, refreshChance: 100, targetType: AbilityTarget.self, unlockedAtLevel: 2, summonId: 'wolf'),
      Ability(name: 'Summon Golem', description: 'A stone golem reduces all incoming damage to the party by 15%.', damage: 0, refreshChance: 100, targetType: AbilityTarget.self, unlockedAtLevel: 4, summonId: 'golem'),
      Ability(name: 'Summon Fairy', description: 'A fairy heals the most injured ally each turn.', damage: 0, refreshChance: 100, targetType: AbilityTarget.self, unlockedAtLevel: 6, summonId: 'fairy'),
      Ability(name: 'Summon Shadow', description: 'A shadow weakens all enemies, reducing their attack each turn.', damage: 0, refreshChance: 100, targetType: AbilityTarget.self, unlockedAtLevel: 8, summonId: 'shadow'),
      Ability(name: 'Summon Swarm', description: 'A swarm of insects damages all enemies each turn.', damage: 0, refreshChance: 100, targetType: AbilityTarget.self, unlockedAtLevel: 11, summonId: 'swarm'),
    ],
  ),
  ...
  CharacterClass.spellsword: ClassDefinition(
    ...
    usesMagicForDamage: true,
    abilities: [
      Ability(name: 'Arcane Slash', description: 'A magic-infused sword strike. Alternating with spells boosts damage!', damage: 11, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true, isPhysicalAttack: true),
      Ability(name: 'Flame Blade', description: 'Your sword erupts in flame. Alternating with spells boosts damage!', damage: 18, refreshChance: 55, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 3, isPhysicalAttack: true),
      ...
      Ability(name: 'Thunder Cleave', description: 'Lightning-charged slash hits all. Alternating with melee boosts damage!', damage: 14, refreshChance: 35, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 8),
      Ability(name: 'Arcane Annihilation', description: 'Unleash all magical energy in one strike. Alternating with melee boosts damage!', damage: 38, refreshChance: 20, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 11),
    ],
  ),

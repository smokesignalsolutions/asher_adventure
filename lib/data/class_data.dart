...
final Map<CharacterClass, ClassDefinition> classDefinitions = {
  CharacterClass.fighter: ClassDefinition(
    ...
    baseStats: const CharacterStats(
      hp: 120,
      attack: 14,
      defense: 12,
      speed: 8,
    ...
    growthRates: const CharacterStats(
      hp: 15,
      attack: 3,
      defense: 2,
      speed: 1,
    ...
    abilities: [
      ...
      Ability(
        name: 'Rallying Cry',
        description:
            'Rally the party! Heals all allies (scales with defense) and boosts defense by 15%.',
        damage: -15,
        refreshChance: 35,
        targetType: AbilityTarget.allAllies,
        unlockedAtLevel: 9,
        defenseBuffPercent: 15,
  ...
  CharacterClass.rogue: ClassDefinition(
    ...
    abilities: [
      ...
      Ability(
        name: 'Backstab',
        description: 'Strike from the shadows for double damage.',
        damage: 22,
        refreshChance: 50,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 2,
      ...
      Ability(
        name: 'Poison Blade',
        description:
            'Envenom your blade, weakening the enemy so all attacks deal more damage.',
        damage: 12,
        refreshChance: 55,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 5,
      ...
      Ability(
        name: 'Shadow Step',
        description: 'Vanish and strike all foes.',
        damage: 10,
        refreshChance: 35,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 8,
      ...
      Ability(
        name: 'Assassinate',
        description: 'A lethal strike to a single target.',
        damage: 40,
        refreshChance: 20,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 12,
  ...
  CharacterClass.cleric: ClassDefinition(
    ...
    abilities: [
      ...
      Ability(
        name: 'Holy Shield',
        description:
            'Raise a divine barrier, healing and boosting all allies\' defense.',
        damage: -10,
        refreshChance: 50,
        targetType: AbilityTarget.allAllies,
        unlockedAtLevel: 4,
      ...
      Ability(
        name: 'Divine Wrath',
        description: 'Call down holy fire on all enemies.',
        damage: 20,
        refreshChance: 25,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 11,
  ...
  CharacterClass.wizard: ClassDefinition(
    ...
    abilities: [
      Ability(
        name: 'Burning Hands',
        description: 'Flames scorch 2-4 enemies.',
        damage: 6,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
      ...
      Ability(
        name: 'Fireball',
        description: 'A ball of fire hits 3-6 enemies.',
        damage: 7,
        refreshChance: 50,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 2,
      ...
      Ability(
        name: 'Ice Storm',
        description: 'A freezing storm hits all enemies.',
        damage: 8,
        refreshChance: 45,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 5,
      ...
      Ability(
        name: 'Meteor',
        description: 'Call a meteor from the sky.',
        damage: 17,
        refreshChance: 20,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 12,
  ...
  CharacterClass.paladin: ClassDefinition(
    ...
    abilities: [
      ...
      Ability(
        name: 'Consecrate',
        description: 'Holy ground damages all foes.',
        damage: 15,
        refreshChance: 35,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 8,
      ...
      Ability(
        name: 'Judgment',
        description: 'Pass divine judgment on an enemy.',
        damage: 35,
        refreshChance: 25,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 11,
  ...
  CharacterClass.ranger: ClassDefinition(
    ...
    abilities: [
      Ability(
        name: 'Arrow Shot',
        description: 'Fire an arrow at the enemy. 15% chance to pierce.',
        damage: 10,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
      ...
      Ability(
        name: 'Twin Shot',
        description:
            'Fire two arrows rapidly. Each arrow hits separately with 15% chance to pierce.',
        damage: 7,
        refreshChance: 55,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 3,
      ...
      Ability(
        name: 'Volley',
        description:
            'Rain arrows on all foes. Each arrow has 15% chance to pierce.',
        damage: 9,
        refreshChance: 40,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 5,
      ...
      Ability(
        ...
        description: 'The forest heals an ally.',
        damage: -18,
        refreshChance: 45,
        targetType: AbilityTarget.singleAlly,
        unlockedAtLevel: 7,
      ...
      Ability(
        name: 'Headshot',
        description: 'A precise shot to the head. 15% chance to pierce.',
        damage: 34,
        refreshChance: 20,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 11,
  ...
  CharacterClass.warlock: ClassDefinition(
    ...
    abilities: [
      Ability(
        name: 'Eldritch Blast',
        description: 'Dark energy lashes out.',
        damage: 12,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
      ...
      Ability(
        name: 'Hex',
        description: 'Curse an enemy, reducing their attack and defense.',
        damage: 8,
        refreshChance: 55,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 2,
      ...
      Ability(
        name: 'Dark Pact',
        description:
            'Sacrifice 15-25% HP. Deal (sacrifice + magic) x 2.5 to all foes.',
        damage: 0,
        refreshChance: 35,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 8,
      ...
      Ability(
        name: 'Doom',
        description: 'Mark an enemy for destruction.',
        damage: 42,
        refreshChance: 20,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 12,
  ...
  CharacterClass.summoner: ClassDefinition(
    ...
    abilities: [
      Ability(
        name: 'Spirit Bolt',
        description: 'Command a spirit to attack.',
        damage: 10,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
      ...
      Ability(
        name: 'Summon Wolf',
        description: 'A wolf spirit attacks a random enemy each turn.',
        damage: 0,
        refreshChance: 100,
        targetType: AbilityTarget.self,
        unlockedAtLevel: 2,
      ...
      Ability(
        name: 'Summon Golem',
        description:
            'A stone golem reduces all incoming damage to the party by 15%.',
        damage: 0,
        refreshChance: 100,
        targetType: AbilityTarget.self,
        unlockedAtLevel: 4,
      ...
      Ability(
        name: 'Summon Fairy',
        description: 'A fairy heals the most injured ally each turn.',
        damage: 0,
        refreshChance: 100,
        targetType: AbilityTarget.self,
        unlockedAtLevel: 6,
      ...
      Ability(
        name: 'Summon Shadow',
        description:
            'A shadow weakens all enemies, reducing their attack each turn.',
        damage: 0,
        refreshChance: 100,
        targetType: AbilityTarget.self,
        unlockedAtLevel: 8,
  ...
  CharacterClass.spellsword: ClassDefinition(
    ...
    abilities: [
      Ability(
        name: 'Arcane Slash',
        description:
            'A magic-infused sword strike. Alternating with spells boosts damage!',
        damage: 11,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
  ...
  CharacterClass.druid: ClassDefinition(
    ...
    abilities: [
      ...
      Ability(
        name: 'Rejuvenate',
        description: 'Nature restores an ally.',
        damage: -22,
        refreshChance: 55,
        targetType: AbilityTarget.singleAlly,
        unlockedAtLevel: 2,
      ...
      Ability(
        name: 'Entangle',
        description:
            'Roots trap all enemies, reducing their attack by 50% for 2 turns.',
        damage: 6,
        refreshChance: 45,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 4,
      ...
      Ability(
        name: 'Wild Growth',
        description: 'Heal the entire party with nature.',
        damage: -14,
        refreshChance: 30,
        targetType: AbilityTarget.allAllies,
        unlockedAtLevel: 7,
      ...
      Ability(
        ...
        description: 'The forest itself attacks.',
        damage: 28,
        refreshChance: 25,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 11,
  ...
  CharacterClass.monk: ClassDefinition(
    ...
    abilities: [
      Ability(
        name: 'Palm Strike',
        description: 'A focused blow with a 20% chance to stun.',
        damage: 7,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
      ...
      Ability(
        ...
        description: 'Rapid strikes with a 30% chance to stun.',
        damage: 12,
        refreshChance: 55,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 2,
      ...
      Ability(
        name: 'Inner Peace',
        description: 'Meditate to restore health and boost defense by 50%.',
        damage: -20,
        refreshChance: 45,
        targetType: AbilityTarget.self,
        unlockedAtLevel: 4,
      ...
      Ability(
        name: 'Sweeping Kick',
        description: 'Kick all enemies with a 25% chance to stun each.',
        damage: 8,
        refreshChance: 40,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 7,
      ...
      Ability(
        name: 'Quivering Palm',
        description:
            'A devastating pressure point strike with a 50% chance to stun.',
        damage: 28,
        refreshChance: 20,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 11,
  ...
  CharacterClass.barbarian: ClassDefinition(
    ...
    abilities: [
      Ability(
        name: 'Cleave',
        description: 'A brutal axe swing.',
        damage: 12,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
      ...
      Ability(
        name: 'Rage',
        description:
            'Enter a fury! Heals 20% HP and boosts attack & defense by 50%.',
        damage: 0,
        refreshChance: 55,
        targetType: AbilityTarget.self,
        unlockedAtLevel: 2,
        healPercentMaxHp: 20,
        attackBuffPercent: 50,
        defenseBuffPercent: 50,
      ),
      Ability(
        name: 'Reckless Swing',
        description: 'Wild attack that hits hard.',
        damage: 24,
        refreshChance: 50,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 4,
      ...
      Ability(
        name: 'War Cry',
        description: 'Terrify all enemies.',
        damage: 14,
        refreshChance: 35,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 7,
      ...
      Ability(
        name: 'Berserker Fury',
        description: 'Unleash unstoppable fury.',
        damage: 45,
        refreshChance: 20,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 11,
  ...
  CharacterClass.sorcerer: ClassDefinition(
    ...
    abilities: [
      ...
      Ability(
        name: 'Chaos Bolt',
        description:
            'Wildly unpredictable magic that may bounce to another enemy.',
        damage: 24,
        refreshChance: 45,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 5,
      ...
      Ability(
        name: 'Arcane Storm',
        description: 'Raw magic strikes all foes.',
        damage: 20,
        refreshChance: 30,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 8,
      ...
      Ability(
        name: 'Reality Warp',
        description: 'Bend reality to devastate enemies.',
        damage: 38,
        refreshChance: 20,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 12,
  ...
  CharacterClass.necromancer: ClassDefinition(
    ...
    abilities: [
      ...
      Ability(
        name: 'Bone Shield',
        description:
            'Surround yourself with bones, healing and boosting defense by 25%.',
        damage: -22,
        refreshChance: 45,
        targetType: AbilityTarget.self,
        unlockedAtLevel: 4,
      ...
      Ability(
        name: 'Plague',
        description: 'Spread disease to all enemies.',
        damage: 16,
        refreshChance: 35,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 7,
      ...
      Ability(
        ...
        description: 'Raise the fallen to fight.',
        damage: 34,
        refreshChance: 20,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 11,
  ...
  CharacterClass.artificer: ClassDefinition(
    ...
    abilities: [
      Ability(
        name: 'Wrench Toss',
        description: 'Hurl a wrench at the enemy.',
        damage: 10,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
      ...
      Ability(
        name: 'Deploy Turret',
        description: 'A turret blasts an enemy.',
        damage: 18,
        refreshChance: 50,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 2,
      ...
      Ability(
        name: 'Bomb',
        description: 'Throw a bomb at all enemies.',
        damage: 16,
        refreshChance: 35,
        targetType: AbilityTarget.allEnemies,
        unlockedAtLevel: 7,
      ...
      Ability(
        name: 'Mech Suit',
        description: 'Don a mech suit! Boosts attack and defense by 50%.',
        damage: 0,
        refreshChance: 20,
        targetType: AbilityTarget.self,
        unlockedAtLevel: 11,
  ...
  CharacterClass.templar: ClassDefinition(
    ...
    abilities: [
      Ability(
        ...
        description: 'A blow guided by faith.',
        damage: 11,
        refreshChance: 100,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 1,
      ...
      Ability(
        name: 'Holy Guard',
        description: 'Heal an ally and grant them 50% of your defense.',
        damage: -18,
        refreshChance: 55,
        targetType: AbilityTarget.singleAlly,
        unlockedAtLevel: 2,
        grantCasterDefensePercent: 50,
      ),
      Ability(
        name: 'Smite Evil',
        description: 'Punish an unholy enemy.',
        damage: 22,
        refreshChance: 50,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 5,
      ...
      Ability(
        name: 'Aura of Light',
        description: 'Heal all allies with radiance.',
        damage: -12,
        refreshChance: 30,
        targetType: AbilityTarget.allAllies,
        unlockedAtLevel: 8,
      ...
      Ability(
        ...
        description: 'Channel all faith into one strike.',
        damage: 38,
        refreshChance: 20,
        targetType: AbilityTarget.singleEnemy,
        unlockedAtLevel: 11,

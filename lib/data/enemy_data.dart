...
final Map<int, List<EnemyTemplate>> enemiesByMap = {
  1: [
    ...
    EnemyTemplate(name: 'Bandit', type: 'bandit', hp: 40, attack: 8, defense: 3, speed: 6, magic: 0, xpReward: 25, goldReward: 12,
      abilities: [Ability(name: 'Slash', description: 'A quick slash.', damage: 8, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
  ],
  2: [
    EnemyTemplate(name: 'Skeleton', type: 'skeleton', hp: 50, attack: 10, defense: 4, speed: 6, magic: 2, xpReward: 30, goldReward: 10,
      abilities: [Ability(name: 'Bone Club', description: 'Whack with a bone.', damage: 10, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Orc Grunt', type: 'orc', hp: 64, attack: 14, defense: 5, speed: 5, magic: 0, xpReward: 35, goldReward: 14,
      abilities: [Ability(name: 'Smash', description: 'A brutal smash.', damage: 14, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Giant Spider', type: 'spider', hp: 48, attack: 12, defense: 3, speed: 8, magic: 0, xpReward: 32, goldReward: 10,
      abilities: [Ability(name: 'Venomous Bite', description: 'A poisonous bite.', damage: 12, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
  ],
  3: [
    EnemyTemplate(name: 'Dark Mage', type: 'dark_mage', hp: 84, attack: 10, defense: 4, speed: 8, magic: 20, xpReward: 40, goldReward: 18,
      abilities: [Ability(name: 'Shadow Bolt', description: 'Dark magic strikes.', damage: 20, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Ogre', type: 'ogre', hp: 130, attack: 22, defense: 7, speed: 3, magic: 0, xpReward: 45, goldReward: 20,
      abilities: [Ability(name: 'Club Slam', description: 'A massive club attack.', damage: 22, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Harpy', type: 'harpy', hp: 76, attack: 18, defense: 4, speed: 11, magic: 8, xpReward: 38, goldReward: 15,
      abilities: [Ability(name: 'Talon Strike', description: 'Razor talons slash.', damage: 18, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
  ],
  4: [
    EnemyTemplate(name: 'Troll', type: 'troll', hp: 200, attack: 32, defense: 10, speed: 4, magic: 0, xpReward: 55, goldReward: 25,
      abilities: [Ability(name: 'Rend', description: 'Tear flesh with claws.', damage: 32, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Wraith', type: 'wraith', hp: 120, attack: 16, defense: 3, speed: 11, magic: 32, xpReward: 58, goldReward: 22,
      abilities: [Ability(name: 'Life Drain', description: 'Drain the life force.', damage: 32, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Minotaur', type: 'minotaur', hp: 180, attack: 36, defense: 9, speed: 6, magic: 0, xpReward: 60, goldReward: 28,
      abilities: [Ability(name: 'Gore', description: 'Charge with horns.', damage: 36, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
  ],
  5: [
    EnemyTemplate(name: 'Wyvern', type: 'wyvern', hp: 220, attack: 40, defense: 12, speed: 10, magic: 16, xpReward: 75, goldReward: 35,
      abilities: [Ability(name: 'Tail Lash', description: 'A whipping tail strike.', damage: 40, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Lich Acolyte', type: 'lich_acolyte', hp: 140, attack: 16, defense: 6, speed: 7, magic: 44, xpReward: 80, goldReward: 40,
      abilities: [Ability(name: 'Necrotic Blast', description: 'Death magic strikes.', damage: 44, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Golem', type: 'golem', hp: 280, attack: 32, defense: 18, speed: 2, magic: 0, xpReward: 70, goldReward: 30,
      abilities: [Ability(name: 'Stone Fist', description: 'A crushing stone punch.', damage: 32, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
  ],
  6: [
    EnemyTemplate(name: 'Vampire', type: 'vampire', hp: 200, attack: 36, defense: 10, speed: 12, magic: 32, xpReward: 95, goldReward: 50,
      abilities: [Ability(name: 'Blood Drain', description: 'Drink your blood.', damage: 36, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Chimera', type: 'chimera', hp: 260, attack: 44, defense: 14, speed: 8, magic: 20, xpReward: 100, goldReward: 45,
      abilities: [Ability(name: 'Triple Strike', description: 'Three heads attack.', damage: 44, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Death Knight', type: 'death_knight', hp: 240, attack: 40, defense: 16, speed: 6, magic: 24, xpReward: 105, goldReward: 55,
      abilities: [Ability(name: 'Unholy Slash', description: 'A cursed blade strike.', damage: 40, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
  ],
  7: [
    EnemyTemplate(name: 'Elder Dragon', type: 'elder_dragon', hp: 320, attack: 52, defense: 18, speed: 10, magic: 40, xpReward: 130, goldReward: 70,
      abilities: [Ability(name: 'Fire Breath', description: 'Breathe searing fire.', damage: 52, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Archdemon', type: 'archdemon', hp: 280, attack: 48, defense: 14, speed: 12, magic: 44, xpReward: 135, goldReward: 65,
      abilities: [Ability(name: 'Hellfire', description: 'Demonic fire engulfs you.', damage: 48, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Titan', type: 'titan', hp: 400, attack: 44, defense: 20, speed: 4, magic: 20, xpReward: 140, goldReward: 60,
      abilities: [Ability(name: 'Colossal Stomp', description: 'Shake the earth.', damage: 44, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
  ],
  8: [
    EnemyTemplate(name: 'Shadow Lord', type: 'shadow_lord', hp: 360, attack: 56, defense: 16, speed: 14, magic: 52, xpReward: 170, goldReward: 80,
      abilities: [Ability(name: 'Void Strike', description: 'Strike from the void.', damage: 56, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Ancient Wyrm', type: 'ancient_wyrm', hp: 440, attack: 60, defense: 22, speed: 8, magic: 36, xpReward: 180, goldReward: 90,
      abilities: [Ability(name: 'Cataclysm', description: 'Devastation incarnate.', damage: 60, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
    EnemyTemplate(name: 'Void Walker', type: 'void_walker', hp: 300, attack: 48, defense: 12, speed: 16, magic: 60, xpReward: 175, goldReward: 85,
      abilities: [Ability(name: 'Reality Tear', description: 'Tear the fabric of reality.', damage: 60, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true)]),
  ],
};
...
final Map<int, EnemyTemplate> bossByMap = {
  1: EnemyTemplate(name: 'Goblin King', type: 'boss', hp: 90, attack: 14, defense: 4, speed: 7, magic: 4, xpReward: 80, goldReward: 50,
    abilities: [
      ...
      Ability(name: 'Call Minions', description: 'Summon goblins to help.', damage: 8, refreshChance: 50, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 1),
    ]),
  2: EnemyTemplate(name: 'Bone Lord', type: 'boss', hp: 160, attack: 20, defense: 7, speed: 5, magic: 12, xpReward: 120, goldReward: 80,
    abilities: [
      Ability(name: 'Bone Crush', description: 'Crushing bones!', damage: 20, refreshChance: 100, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1, isBasicAttack: true),
  ...
  3: EnemyTemplate(name: 'Shadow Witch', type: 'boss', hp: 240, attack: 16, defense: 6, speed: 10, magic: 32, xpReward: 160, goldReward: 110,
    abilities: [
      ...
      Ability(name: 'Curse All', description: 'Curse the entire party.', damage: 20, refreshChance: 40, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 1),
    ]),
  4: EnemyTemplate(name: 'Mountain Giant', type: 'boss', hp: 500, attack: 44, defense: 16, speed: 3, magic: 0, xpReward: 200, goldReward: 140,
    abilities: [
      ...
      Ability(name: 'Earthquake', description: 'The ground shakes!', damage: 32, refreshChance: 40, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 1),
    ]),
  5: EnemyTemplate(name: 'Lich King', type: 'boss', hp: 400, attack: 28, defense: 12, speed: 8, magic: 60, xpReward: 250, goldReward: 180,
    abilities: [
      ...
      Ability(name: 'Mass Wither', description: 'Wither all life.', damage: 36, refreshChance: 40, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 1),
    ]),
  6: EnemyTemplate(name: 'Demon Prince', type: 'boss', hp: 560, attack: 52, defense: 18, speed: 10, magic: 48, xpReward: 300, goldReward: 220,
    abilities: [
      ...
      Ability(name: 'Rain of Fire', description: 'Fire falls from above.', damage: 40, refreshChance: 40, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 1),
    ]),
  7: EnemyTemplate(name: 'Dragon Emperor', type: 'boss', hp: 700, attack: 64, defense: 22, speed: 12, magic: 56, xpReward: 400, goldReward: 300,
    abilities: [
      ...
      Ability(name: 'Inferno', description: 'Engulf all in flame.', damage: 48, refreshChance: 35, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 1),
    ]),
  8: EnemyTemplate(name: 'The Dark One', type: 'boss', hp: 1000, attack: 72, defense: 24, speed: 14, magic: 72, xpReward: 600, goldReward: 500,
    abilities: [
      ...
      Ability(name: 'Apocalypse', description: 'End of all things.', damage: 56, refreshChance: 35, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 1),
  ...
  return [
    ...
    EnemyTemplate(
      ...
      abilities: [
        ...
        Ability(name: 'Shield Bash', description: 'Bash with a heavy shield.', damage: 6 + s * 4, refreshChance: 50, targetType: AbilityTarget.singleEnemy, unlockedAtLevel: 1),
      ],
    ),
    ...
    EnemyTemplate(
      ...
      abilities: [
        ...
        Ability(name: 'Arcane Blast', description: 'Blast all foes.', damage: 6 + s * 4, refreshChance: 40, targetType: AbilityTarget.allEnemies, unlockedAtLevel: 1),
      ],
    ),
  ];
}

...
final Map<int, List<Equipment>> shopItemsByMap = {
  ...
  1: [
    ...
    const Equipment(id: 'rusty_dagger', name: 'Rusty Dagger', slot: EquipmentSlot.weapon, rarity: Rarity.common, attackBonus: 2, speedBonus: 2, value: 30),
    const Equipment(id: 'twig_wand', name: 'Twig Wand', slot: EquipmentSlot.weapon, rarity: Rarity.common, magicBonus: 2, speedBonus: 2, value: 30),
    // Offhand
  ...
  2: [
    ...
    const Equipment(id: 'steel_dagger', name: 'Steel Dagger', slot: EquipmentSlot.weapon, rarity: Rarity.uncommon, attackBonus: 4, speedBonus: 2, value: 60),
    const Equipment(id: 'oak_wand', name: 'Oak Wand', slot: EquipmentSlot.weapon, rarity: Rarity.uncommon, magicBonus: 4, speedBonus: 2, value: 60),
    // Offhand
  ...
  3: [
    ...
    const Equipment(id: 'enchanted_dagger', name: 'Enchanted Dagger', slot: EquipmentSlot.weapon, rarity: Rarity.rare, attackBonus: 5, speedBonus: 3, value: 100),
    const Equipment(id: 'crystal_wand', name: 'Crystal Wand', slot: EquipmentSlot.weapon, rarity: Rarity.rare, magicBonus: 6, speedBonus: 3, value: 100),
    // Offhand
  ...
  4: [
    ...
    const Equipment(id: 'runic_dagger', name: 'Runic Dagger', slot: EquipmentSlot.weapon, rarity: Rarity.rare, attackBonus: 7, speedBonus: 3, value: 160),
    const Equipment(id: 'runic_wand', name: 'Runic Wand', slot: EquipmentSlot.weapon, rarity: Rarity.rare, magicBonus: 8, speedBonus: 3, value: 160),
    // Offhand
  ...
  5: [
    ...
    const Equipment(id: 'mythril_dagger', name: 'Mythril Dagger', slot: EquipmentSlot.weapon, rarity: Rarity.epic, attackBonus: 9, speedBonus: 3, value: 250),
    const Equipment(id: 'mythril_wand', name: 'Mythril Wand', slot: EquipmentSlot.weapon, rarity: Rarity.epic, magicBonus: 10, speedBonus: 3, value: 250),
    // Offhand
  ...
  6: [
    ...
    const Equipment(id: 'shadow_dagger', name: 'Shadow Dagger', slot: EquipmentSlot.weapon, rarity: Rarity.epic, attackBonus: 11, speedBonus: 4, value: 350),
    const Equipment(id: 'void_wand', name: 'Void Wand', slot: EquipmentSlot.weapon, rarity: Rarity.epic, magicBonus: 12, speedBonus: 4, value: 350),
    // Offhand
  ...
  7: [
    ...
    const Equipment(id: 'assassins_blade', name: "Assassin's Blade", slot: EquipmentSlot.weapon, rarity: Rarity.legendary, attackBonus: 15, speedBonus: 4, value: 500),
    const Equipment(id: 'wand_of_the_ancients', name: 'Wand of the Ancients', slot: EquipmentSlot.weapon, rarity: Rarity.legendary, magicBonus: 16, speedBonus: 4, value: 500),
    // Offhand
  ...
  8: [
    ...
    const Equipment(id: 'godstrike_dagger', name: 'Godstrike Dagger', slot: EquipmentSlot.weapon, rarity: Rarity.legendary, attackBonus: 18, speedBonus: 5, value: 800),
    const Equipment(id: 'wand_of_oblivion', name: 'Wand of Oblivion', slot: EquipmentSlot.weapon, rarity: Rarity.legendary, magicBonus: 20, speedBonus: 5, value: 800),
    // Offhand
